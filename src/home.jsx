        ...
        <div className="footer-inner">
          ...
          <div className="footer-section">
            ...
            <div className="footer-copy">
              Your trusted platform for finding love and companionship. We believe in bringing hearts together with trust, respect, and authenticity.
            </div>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="footer-item">
              ...
              <div className="footer-item-text">
                <a href="mailto:info@chennaiprofiles.com">info@chennaiprofiles.com</a>
              </div>
            </div>
          </div>
          ...
          <div className="footer-bottom">
            <div className="footer-bottom-text">
              © 2026 Chennai Profiles · All Rights Reserved · Designed with ❤️ for Love
            </div>
          </div>
        </div>
      </footer>
